...
\begin{columns}[c]
  \column{0.43\textwidth}
    ...
    \end{alertblock}
    \vspace{2pt}
    \begin{exampleblock}{Asymétrie observée}
...
% ────────────────────────────────────────────────────────
\begin{frame}{Clustering : 4 profils robustes : ARI\,=\,0,98}
\begin{columns}[c]
  ...
  \column{0.47\textwidth}
    \begin{alertblock}{Convergence CAH-Ward / K-means}
      \footnotesize\centering
      $\mathrm{ARI}=0{,}98\;\Rightarrow$ \textbf{partitions très similaires}\\
      Résultat robuste, indépendant de la méthode.\\
      {\scriptsize\itshape $K=4$ choisi par la méthode de la silhouette.}
    \end{alertblock}
    \vspace{4pt}
    {\footnotesize
