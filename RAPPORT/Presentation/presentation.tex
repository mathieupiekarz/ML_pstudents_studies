...
\begin{columns}[c]
  \column{0.42\textwidth}
    \begin{block}{Distance de Gower : variables hétérogènes (Ch.\,2)}
      \footnotesize
    ...
    \end{block}
    \vspace{3pt}
    \begin{block}{AFTD : Analyse Factorielle des Distances (Ch.\,6)}
      \footnotesize
...
\begin{columns}[c]
  ...
  \column{0.47\textwidth}
    \begin{alertblock}{Convergence CAH-Ward / K-means (Ch.\,7)}
      \footnotesize\centering
...
\begin{columns}[c]
  ...
  \column{0.48\textwidth}
    \begin{block}{Phase B : AUC-ROC (CV 5-fold, Ch.\,13)}
      \footnotesize
      ...
      \begin{tabular}{lcc}
        ...
        LightGBM \scriptsize(Ch.12§4)  & 0,702  & 21,3\,\%   \\
        \bottomrule
      \end{tabular}\\[3pt]
      \code{class\_weight='balanced'} : déséquilibre 1:10\\
    ...
    \begin{alertblock}{Limite fondamentale}
      ...
      Prédiction individuelle limitée ($n_\mathrm{décrocheurs}=38$).
    \end{alertblock}
\end{columns}
\end{frame}
...
\begin{columns}[c]
  \column{0.44\textwidth}
    \begin{block}{Neyman-Pearson (Ch.9 §2) sur LogReg}
      \footnotesize
